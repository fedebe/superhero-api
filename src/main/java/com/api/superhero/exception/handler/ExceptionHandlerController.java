...
public class ExceptionHandlerController {
    ...
    public ResponseEntity<ErrorInfo> methodArgumentNotValidException(HttpServletRequest request,
        ...
        ErrorInfo errorInfo = new ErrorInfo(errorMessages.toArray(String[]::new), HttpStatus.BAD_REQUEST.value(),
    ...
    public ResponseEntity<ErrorInfo> superheroException(HttpServletRequest request, SuperheroException e) {
        ...
        ErrorInfo errorInfo = new ErrorInfo(Arrays.asList(e.getMessage()).toArray(String[]::new), e.getStatus().value(),
                request.getRequestURI());
    ...
    public ResponseEntity<ErrorInfo> typeMismatchException(HttpServletRequest request, TypeMismatchException e) {
        ...
        if (e.getCause() != null && e.getCause().getCause() instanceof SuperheroException se) {
            errorInfo = new ErrorInfo(Arrays.asList(se.getMessage()).toArray(String[]::new), se.getStatus().value(),
                    request.getRequestURI());
        } else {
            errorInfo = new ErrorInfo(Arrays.asList(e.getMessage()).toArray(String[]::new),
                    HttpStatus.BAD_REQUEST.value(), request.getRequestURI());
        }

        return new ResponseEntity<>(errorInfo, HttpStatus.resolve(errorInfo.statusCode()));
    }
    ...
    public ResponseEntity<ErrorInfo> captureAllExceptions(HttpServletRequest request, Exception e) {
        ...
        ErrorInfo errorInfo = new ErrorInfo(errorMessages.toArray(String[]::new),
